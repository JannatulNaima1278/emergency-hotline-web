...
let currentHeartCount = parseInt(heartCount.textContent.trim()) || 0;

heartBtn.forEach(iconButton => {

       iconButton.addEventListener('click', function(){
           currentHeartCount++;
           
           heartCount.textContent = currentHeartCount;
       });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!navbarCountSpan) {
        console.error("The ID for the Navbar counter was not found.");
        return;
    }
        ...
        button.addEventListener('click', function() {
            ...
            if (navigator.clipboard) {
                ...
                .then(() => {
                    ...
                    const alertMessage = `Number copied: ${numberToCopy}`;
                    alert(alertMessage);
